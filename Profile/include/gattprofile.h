...
// Profile Parameters
#define SIMPLEPROFILE_CHAR_TXT         0
#define SIMPLEPROFILE_CHAR_CMD         1
#define SIMPLEPROFILE_CHAR_ANS         2

// Simple Profile Service UUID
#define SIMPLEPROFILE_SERV_UUID     0xFFE0

// Key Pressed UUID
#define SIMPLEPROFILE_CHAR1_UUID    0x2A3D //0xFFE1
...
#define SIMPLEPROFILE_CHAR_TXT_LEN     192
#define SIMPLEPROFILE_CHAR_CMD_LEN     2
#define SIMPLEPROFILE_CHAR_ANS_LEN     248
