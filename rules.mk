...
OPT			?= -Os -Wextra # -Og
CSTD		?= -std=gnu99
TGT_CFLAGS 	+= $(ARCH_FLAGS) $(DEBUG_FLAGS) $(OPT) $(CSTD) $(addprefix -D, $(LIB_FLAGS)) -DSW_VERSION_=$(SW_VERSION) -DDT_UNIX=$(DT_UNIX) -Wall -ffunction-sections -fdata-sections -fno-common
...
ifndef GCC_TOOLCHAIN
	$(error GCC_TOOLCHAIN is not set. E.g. run "make GCC_TOOLCHAIN=/path/MRS_Toolchain/RISC-V_Embedded_GCC12/bin")
endif
	@printf "  CC\t$<\n"
	@mkdir -p $(dir $@)
